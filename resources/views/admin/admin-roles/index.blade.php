...
@section('admin-content')
    <div class="space-y-6">
        ...
        <!-- Header -->
        <x-ui.page-header title="Admin Roles" description="Manage admin roles and account permissions." />

        <!-- Action Bar -->
        <div class="flex items-center justify-between">
            <div class="text-sm text-gray-700 dark:text-gray-300">
                <strong class="font-bold text-lg">Total Roles:</strong> <span
                    class="font-semibold">{{ $adminRoles->total() }}</span>
            </div>

            <div class="flex items-center gap-3">

                <!-- Search Form -->
                <form method="GET" action="{{ route('admin.admin-roles.index') }}" class="flex items-center gap-3" id="searchForm">
                    <div class="relative">
                        <input type="text" 
                               name="search" 
                               id="searchInput"
                ...
                <!-- Add Button -->
                <x-ui.button href="{{ route('admin.admin-roles.create') }}" variant="primary" size="md"
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/40 transition">
                                ...
                                <td class="px-6 py-4 ">
                                    <div class="flex items-center gap-1">
                                        ...
                                        <!-- View -->
                                        <a href="{{ route('admin.admin-roles.show', $role->id) }}"
                                        ...
                                        <!-- Delete -->
                                        <form method="POST" action="{{ route('admin.admin-roles.destroy', $role->id) }}"
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-16 text-center text-gray-500 dark:text-gray-400">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-sm">Create a new role to get started.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse

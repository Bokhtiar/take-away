...
class MenuPermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $menuPermissions = [
            ...
            // Product List (Child with ALL actions)
            ['menu_id' => 16, 'permission_id' => $accessId],
            ['menu_id' => 16, 'permission_id' => $createId],
            ['menu_id' => 16, 'permission_id' => $editId],
            ['menu_id' => 16, 'permission_id' => $viewId],
            ['menu_id' => 16, 'permission_id' => $deleteId],
            ...
            // Addons (Child with ALL actions)
            ['menu_id' => 14, 'permission_id' => $accessId],
            ['menu_id' => 14, 'permission_id' => $createId],
